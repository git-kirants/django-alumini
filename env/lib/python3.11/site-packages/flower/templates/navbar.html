<nav class="navbar navbar-expand-lg navbar-light bg-green mx-2">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
      <li class="nav-item">
        <a class="nav-link py-2 px-0 px-lg-2" href="{% url 'notifications' %}" title="Notifications">
          <i class="fas fa-bell"></i>
          <span class="badge bg-danger">3</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link py-2 px-0 px-lg-2" href="{% url 'messaging:conversation_list' %}" title="Messages">
